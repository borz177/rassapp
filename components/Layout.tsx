...
useEffect(() => {
    ...
    if (theme) {
        ...
        // 🔹 Устанавливаем цвета для навбара (берем из primary)
        root.style.setProperty('--navbar-bg', theme.primary['600']);
        root.style.setProperty('--navbar-text', '#ffffff');
        root.style.setProperty('--navbar-border', theme.primary['700']);
        root.style.setProperty('--navbar-hover', theme.primary['700']);
        root.style.setProperty('--navbar-activeBg', theme.primary['700']);
        root.style.setProperty('--navbar-activeText', '#ffffff');
    }
}, [appSettings.theme]);
