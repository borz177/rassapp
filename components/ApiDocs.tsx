  ...
  -d '{"contractId":"sale_…","amount":20000}'`}</Code>
          ...
          <Section id="assistant" title="Подключить помощника (ChatGPT)">
            ...
            <P>
              ...
              Протокол MCP мы отдельно не поддерживаем: он для другого — так подключаются настольные
              помощники к локальным программам, и для работы по сети ему всё равно нужен этот же
              ключ и эти же маршруты.
            </P>
