...
const config: CapacitorConfig = {
  ...
  plugins: {
    StatusBar: {
      // Приложение рисуется под статус-баром: часы и значки лежат прямо на шапке,
      // как в нативных приложениях. Вырез отдаётся вёрстке через
      // env(safe-area-inset-top) — см. .safe-area-top и .mobile-main-offset.
      ...
      style: 'LIGHT',
      backgroundColor: '#00000000', // прозрачный: полосу закрывает сама шапка
    },
    SplashScreen: {
